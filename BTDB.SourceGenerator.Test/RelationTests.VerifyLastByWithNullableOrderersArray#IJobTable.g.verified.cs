...
file class IJobTableRegistration
{
    public class ImplJobTable : global::BTDB.ODBLayer.RelationDBManipulator<global::Job>, global::IJobTable
    {
        ...
        [SkipLocalsInit]
        global::Job? global::IJobTable.LastByLastUpdateOrDefault(BTDB.ODBLayer.Constraint<ulong> companyId, BTDB.ODBLayer.IOrderer[]? orderer)
        {
            var c_c = new ConstraintInfo[1];
            c_c[0].Constraint = companyId;
            return LastBySecondaryKey<global::Job>(0, c_c, 0u, orderer, true);
        }
    }
    [ModuleInitializer]
