...
namespace BTDB.IL
{
    internal class ILDynamicTypeImpl : IILDynamicType
    {
        ...
        public IILMethod DefineMethod(string name, Type returns, Type[] parameters, MethodAttributes methodAttributes = MethodAttributes.Public)
        {
            ...
            return new ILMethodImpl(methodBuilder);
        }
        ...
        {
            return new ILConstructorImpl(_typeBuilder.DefineConstructor(MethodAttributes.Public, CallingConventions.Standard, parameters));
        }
