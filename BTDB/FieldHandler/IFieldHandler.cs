...
{
    public static bool UseNoEmit = true;
    public static bool UseNoEmitForKeyValue = true;
    public static bool UseNoEmitForRelations = true;
    public static bool UseNoEmitForDescriptors = true;
