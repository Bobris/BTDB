...
namespace BTDB.ODBLayer
{
    public class ODBDictionaryFieldHandler : IFieldHandler
    {
        ...
        ODBDictionaryFieldHandler(IFieldHandlerFactory fieldHandlerFactory, ITypeConvertorGenerator typeConvertorGenerator, Type type, IFieldHandler keySpecialized, IFieldHandler valueSpecialized)
        {
        ...
        public IFieldHandler SpecializeLoadForType(Type type)
        {
            ...
            return new ODBDictionaryFieldHandler(_fieldHandlerFactory, _typeConvertorGenerator, type, keySpecialized,valueSpecialized);
        }
