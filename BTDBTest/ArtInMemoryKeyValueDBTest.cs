...
namespace BTDBTest
{
    public class ArtInMemoryArtInMemoryKeyValueDBTest: IDisposable
    {
        ...
        {
            using (new ArtInMemoryKeyValueDB(_allocator))
            {
            }
        }
        ...
        {
            using (IKeyValueDB db = new ArtInMemoryKeyValueDB(_allocator))
            {
        ...
        private LeakDetectorWrapperAllocator _allocator;
    }
}
