...
namespace BTDBTest
{
    public abstract class KeyValueDBTestBase
    {
        ...
        public abstract IKeyValueDB NewKeyValueDB(IFileCollection fileCollection);
        public abstract IKeyValueDB NewKeyValueDB(IFileCollection fileCollection, ICompressionStrategy compression, uint fileSplitSize = int.MaxValue);
        public abstract IKeyValueDB NewKeyValueDB(IFileCollection fileCollection, ICompressionStrategy compression, uint fileSplitSize,
            ICompactorScheduler compactorScheduler);
        public abstract IKeyValueDB NewKeyValueDB(KeyValueDBOptions options);
        ...
        public void RepairsOnReopen()
        {
            using (var fileCollection = new InMemoryFileCollection())
            {
                using (IKeyValueDB db = NewKeyValueDB(fileCollection))
                {
                    ...
                    using (IKeyValueDB db2 = NewKeyValueDB(fileCollection))
                    {
